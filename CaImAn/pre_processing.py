...
# modification of pre_processing.py from package caiman/source_extraction/cnmf
# to be imported in a modifier summary_images.py because of caiman_pnrCorr_run.py
