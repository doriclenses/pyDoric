...
dims, T = utils.get_dims(paths['fname'], paths['h5path']+'ImageStack')
...
if __name__ == "__main__":
    ...
    with h5py.File(paths["fname"], 'r') as f:
        images = np.array(f[paths['h5path']+'ImageStack'])
    ...
    attrs = utils.load_attributes(paths['fname'], paths['h5path']+'/ImageStack')
