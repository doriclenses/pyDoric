...
def save_minian_to_doric(
    ...
    with h5py.File(vname, 'a') as f:
        ...
        params_doric[mn_defs.ParametersKeys.OPRETATION] += operationCount
        ...
        if saveimages:
            ...
            utils.save_attributes(utils.merge_params(params_doric, params_source, params_doric[mn_defs.ParametersKeys.OPRETATION] + "(Images)"), f, pathImages)
        ...
        if saveresiduals:
            ...
            utils.save_attributes(utils.merge_params(params_doric, params_source,  params_doric[mn_defs.ParametersKeys.OPRETATION] + "(Residuals)"), f, pathResiduals)
